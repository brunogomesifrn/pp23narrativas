...
from apps.narrativa.models import Tipo_Narrativa
from apps.narrativa.forms import Tipo_NarrativaForm
from apps.narrativa.models import Estilo_Narrativa
from apps.narrativa.forms import Estilo_Narrativaform
